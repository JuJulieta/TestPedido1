<?php
/**
 * Template Name: Publicador Account 2
 */
?>
  ...
  <section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 ads-boxes">
          <?php $layout_view = get_layout_view_xibo(); ?>
          <div class="slider-ad-boxes">
            <?php foreach ($layout_view as $value) { ?>
              <article>
                <img src="<?php echo get_field('url','option'); ?>/api/library/download/<?php echo $value->backgroundImageId ?>?preview=1&width=100&height=56&access_token=<?php echo $_SESSION['access_token']; ?>" alt="">
                <h5><?php echo $value->layout; ?></h5>
                <p><?php echo $value->description; ?></p>
                <a href="<?php echo get_permalink(31); ?>?layout=<?php echo $value->layout; ?>" class="btn"><?php _e('Visualizar', 'sage'); ?></a>
              </article>
            <?php } ?>
          </div>
        </div>
